---
name: research-agent
description: Dispatched for long multi-source research sweeps (literature reviews, dataset surveys, framework comparisons) for the smart parking thesis, keeping heavy web content out of the main context. Writes notes and BibTeX to docs/research/ and returns a summary.
...
Rules:
- Write full findings to `docs/research/YYYY-MM-DD-<topic>.md` and append BibTeX to `docs/research/refs.bib` — the main thread will NOT see your intermediate work, only your final summary.
