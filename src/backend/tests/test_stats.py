...
def test_stats_revenue_and_counts(client, db_session, admin_headers):
    ...
    r = client.get("/stats", params={"from": "2026-08-22T00:00:00", "to": "2026-08-22T23:59:59"}, headers=admin_headers)
